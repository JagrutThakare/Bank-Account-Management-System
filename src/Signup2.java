...
public class Signup2 extends JFrame implements ActionListener {
    ...
    Signup2(String formno) {
        ...
        l11.setFont(new Font("Poppins", Font.BOLD, 18));
        ...
        l9.setFont(new Font("Poppins", Font.BOLD, 18));

        l10 = new JLabel("Existing Account:");
        l10.setFont(new Font("Poppins", Font.BOLD, 18));

        l12 = new JLabel("Form No:");
        l12.setFont(new Font("Poppins", Font.BOLD, 13));

        l13 = new JLabel(formno);
        l13.setFont(new Font("Poppins", Font.BOLD, 13));
